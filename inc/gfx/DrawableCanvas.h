...
public:
	...
	virtual void drawCircle(int hcenter, int vcenter, int radius, const Pixel& color) const;
//	virtual void drawCircle(int hcenter, int vcenter, int radius, int width, const Pixel& color, uint8_t dashFill, uint8_t dashSkip) const;

//	virtual void drawCircle(int hcenter, int vcenter, int radius, int width, const PixelColorProvider& provider) const;
//	virtual void drawCircle(int hcenter, int vcenter, int radius, int width, const PixelColorProvider& provider, uint8_t dashFill, uint8_t dashSkip) const;
